  ...
  return (
    <section className="relative mt-10 overflow-hidden rounded-3xl bg-white text-black ring-1 ring-neutral-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 text-center">
        <div className="inline-flex items-center gap-2 rounded-full bg-neutral-100 text-neutral-700 px-3 py-1 text-xs ring-1 ring-neutral-200">Standard</div>
        <h3 className="mt-3 text-2xl md:text-3xl font-extrabold tracking-tight">Start trading with Fynixfx Standard Account</h3>
        <p className="mt-2 text-neutral-600">All‑in‑spread pricing with deep liquidity and fast execution</p>
