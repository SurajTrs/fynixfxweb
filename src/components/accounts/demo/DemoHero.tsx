    ...
    <section className="relative isolate overflow-hidden pt-28 md:pt-32 pb-16 md:pb-20 min-h-[64vh] bg-black flex items-center rounded-b-3xl md:rounded-b-[3rem]">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-white">
          Try a <span className="brand-gradient-text">Free Demo</span>
        </h1>
        <p className="mt-4 sm:mt-5 max-w-3xl mx-auto text-base sm:text-lg text-white/85">
          Practice trading with virtual funds on professional platforms and real‑time pricing.
        </p>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link href="/accounts/live" className="inline-flex items-center justify-center rounded-md border border-white/30 text-white font-semibold px-7 py-3.5 hover:bg-white/10 transition">
            Open Live Account
          </Link>
        </div>
      </div>
