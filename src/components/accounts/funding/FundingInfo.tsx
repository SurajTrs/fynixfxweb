      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="space-y-6">
          <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-2 text-[13px] text-neutral-600">Such cases are outside of IC Markets Global control, and we shall not be held liable for any losses or additional losses.</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm text-neutral-700">
                IC Markets Global does not charge additional fees for deposits or withdrawals. You may incur intermediary fees depending on your bank. IC Markets Global accepts no responsibility for such fees.
              </p>
            </div>
            <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
