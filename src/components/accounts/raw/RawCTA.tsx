  ...
  return (
    <section className="relative mt-10 overflow-hidden rounded-3xl bg-white text-black ring-1 ring-neutral-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 text-center">
        <div className="inline-flex items-center gap-2 rounded-full bg-neutral-100 text-neutral-700 px-3 py-1 text-xs ring-1 ring-neutral-200">Raw Spread</div>
        <h3 className="mt-3 text-2xl md:text-3xl font-extrabold tracking-tight">Start trading with Fynixfx Raw Spread Account</h3>
