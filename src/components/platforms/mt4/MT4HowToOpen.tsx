...
export default function MT4HowToOpen() {
  const steps = [
    ...
    { n: 3, title: "Download MT4", desc: "Install MT4 on desktop or mobile and log in securely." },
  ];
  return (
    <section id="trade" className="py-14 bg-neutral-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight text-black">How to open an MT4 account with Fynixfx</h2>
