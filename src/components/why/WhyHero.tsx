  ...
  return (
    <section className="relative isolate overflow-hidden pt-28 md:pt-32 pb-16 md:pb-20 min-h-[80vh] md:min-h-[86vh] bg-black flex items-center rounded-b-3xl md:rounded-b-[3rem]">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        <div className="text-xs uppercase tracking-[0.25em] text-white/70 mb-3">Why Choose</div>
        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-white">
          Why Choose <span className="brand-gradient-text">Fynixfx</span>
        </h1>
        <p className="mt-4 sm:mt-5 max-w-3xl mx-auto text-base sm:text-lg text-white/85">
          Experience raw spreads, lightning-fast execution, and institutional-grade liquidity on a secure, regulated multi-asset platform.
        </p>
        ...
        <div className="mt-6 sm:mt-8 flex flex-wrap items-center justify-center gap-3 text-xs sm:text-sm">
          ...
          <span className="inline-flex items-center gap-2 rounded-full bg-white/10 text-white px-3 py-1.5 ring-1 ring-white/15 backdrop-blur-sm"><span className="text-[color:var(--brand)]">✓</span> 24/7 specialist support</span>
        </div>
      </div>
    </section>
  );
