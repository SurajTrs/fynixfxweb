  ...
  return (
    <section className="relative isolate overflow-hidden pt-24 md:pt-28 pb-14 md:pb-16 bg-black text-white rounded-b-3xl md:rounded-b-[3rem]">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight">Open your Fynixfx Account</h1>
        <p className="mt-4 max-w-3xl mx-auto text-white/85">
          Create your live trading account in minutes. Simple steps, secure onboarding.
        </p>
      </div>
    </section>
  );
