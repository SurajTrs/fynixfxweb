...
export default function BNOverview() {
  const facts = [
    ...
    <section className="py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-6 items-start">
        <div className="md:col-span-2 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-neutral-200">
          ...
          <h2 className="mt-2 text-2xl md:text-3xl font-extrabold tracking-tight text-black">What are Bonds CFDs?</h2>
          <p className="mt-2 text-[15px] leading-7 text-neutral-700">
            Bonds CFDs allow you to speculate on changes in interest rates by trading government bonds and notes.
            Take macro views on monetary policy and inflation while keeping costs and sizing flexible.
          </p>
        </div>
