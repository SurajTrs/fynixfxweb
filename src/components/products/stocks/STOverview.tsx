    ...
    <section className="py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-6 items-start">
        ...
        <div className="md:col-span-2 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-neutral-200">
          ...
          <h2 className="mt-2 text-2xl md:text-3xl font-extrabold tracking-tight text-black">What are Stocks CFDs?</h2>
          <p className="mt-2 text-[15px] leading-7 text-neutral-700">
            Stocks CFDs allow you to speculate on the price of individual companies without owning the shares.
            Trade long or short with flexible sizing and clear cost visibility.
          </p>
          <p className="mt-2 text-[15px] leading-7 text-neutral-700">
            With Fynixfx, access popular US, EU and AU equities on professional platforms with competitive
            pricing and responsive execution.
          </p>
        </div>
