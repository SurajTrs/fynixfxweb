    ...
    <section className="py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-6 items-start">
        ...
        <div className="md:col-span-2 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-neutral-200">
          ...
          <h2 className="mt-2 text-2xl md:text-3xl font-extrabold tracking-tight text-black">What is Forex?</h2>
          <p className="mt-2 text-[15px] leading-7 text-neutral-700">
            The foreign exchange (forex) market is the world’s most liquid financial market where currencies are
            traded in pairs. Prices reflect the relative value between two economies and are influenced by rates,
            growth and risk sentiment. Forex is used for speculation, hedging and international commerce.
          </p>
          <p className="mt-2 text-[15px] leading-7 text-neutral-700">
            With Fynixfx, you can access major, minor and exotic pairs on professional platforms with transparent
            costs and responsive execution.
          </p>
        </div>
