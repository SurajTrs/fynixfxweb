    ...
    <section className="py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-6 items-start">
        ...
        <div className="md:col-span-2 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-neutral-200">
          ...
          <h2 className="mt-2 text-2xl md:text-3xl font-extrabold tracking-tight text-black">What are Digital Currencies CFDs?</h2>
          <p className="mt-2 text-[15px] leading-7 text-neutral-700">
            Crypto CFDs allow you to speculate on price moves in digital assets without managing wallets or
            custody. Go long or short with flexible sizing while keeping costs transparent and execution
            responsive.
          </p>
          <p className="mt-2 text-[15px] leading-7 text-neutral-700">
            With Fynixfx, access popular crypto instruments on professional platforms with prudent risk controls
