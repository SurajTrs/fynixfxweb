    ...
    <section className="py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-6 items-start">
        <div className="md:col-span-2 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-neutral-200">
          ...
          <h2 className="mt-2 text-2xl md:text-3xl font-extrabold tracking-tight text-black">What are Indices CFDs?</h2>
          <p className="mt-2 text-[15px] leading-7 text-neutral-700">
            Indices CFDs let you trade price movements of equity market benchmarks like US500, US30 or GER40.
            Express macro views and manage equity exposure with transparent costs and responsive execution.
          </p>
        </div>
